...
# ----- 2.获取语法任务坐标 ----- #
prompts = ["请点击语法", "请点击目标卡包", "请点击下一个"]
grammar = [get_click_coordinate(prompt) for prompt in prompts]  # 获取所有坐标并保存
...
print("语法坐标已保存到 coordinates.json 文件中")
